...
The most out-of-date part of this course is the version of Next.js being used. Lots has happened in the world of Next.js since version 10, particularly in the latest version 15. Now we have partial rerendering, server components, server actions, and more.
